...
for idx, row in questions_df.iterrows():
  ...
  # === 5.1 Генерация эмбеддинга вопроса ===
    ...
    print(f"📏 Отправляемый промпт: {len(tokens)} токенов")
